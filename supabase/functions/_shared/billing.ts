...
export const PRODUCTS = Object.freeze({
  keeper_unlock_v1: Object.freeze({ amountCents: 199, previousPlans: ["free"] as const, resultingPlan: "keeper_unlock_v1" as const, priceSecret: "STRIPE_PRICE_KEEPER_UNLOCK_199" }),
  keeper_unlimited_v1: Object.freeze({ amountCents: 499, previousPlans: ["free", "keeper_unlock_v1"] as const, resultingPlan: "keeper_unlimited_v1" as const, priceSecret: "STRIPE_PRICE_KEEPER_UNLIMITED_499" }),
});

...
test("production build contains the Keeper application", async () => {
  ...
  assert.match(bundle, /Enthusiast maintenance intelligence/);
  assert.match(bundle, /KNOWLEDGE \+ ORGANIZATION \+ VEHICLE HISTORY/);
  assert.match(bundle, /Keeper is a digital ownership guide and service record for enthusiast cars\./);
  ...
  assert.doesNotMatch(bundle, /What needs attention/);
  assert.match(bundle, /Recorded spending/);
  assert.match(bundle, /Independent vehicle ownership research and workshop records/);
  assert.match(bundle, /Keeper v/);
  assert.match(bundle, /1\.0\.0/);
  assert.match(bundle, /support@keeperauto\.com/);

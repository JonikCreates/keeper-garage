...
export function LegalPage({ page, onOpenAccount }: LegalPageProps) {
  ...
  return <section className="legal-page" aria-labelledby="legal-page-title">
    ...
    {page === "terms" && <div className="legal-document">
      ...
      <section><h2>Attorney-review placeholders</h2><p>Before commercial launch, counsel should complete provisions covering acceptable use, availability, intellectual property, user data, termination, one-time purchases, refunds, warranties, liability, disputes, governing law, and changes to these terms. Keeper does not add arbitration or class-action waivers through this draft.</p></section>
    </div>}
